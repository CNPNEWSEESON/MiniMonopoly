...
เมื่อเปิดเกม จะมีหน้าเมนูเริ่มต้น:

- กด `1` หรือ `N` — New Game (เริ่มเกมใหม่)
- กด `2`, `R` หรือ `C` — Resume Game (โหลดเกมที่เล่นค้างไว้ ถ้ามีเซฟ)
- กด `Q` — Quit

**หมายเหตุ:** เกมนี้ไม่มีให้เลือกระดับความยากของตัวเอง — เมื่อเริ่มเกมใหม่ ผู้เล่น (Human) จะเจอ Bot ทั้ง 3 ระดับพร้อมกันในเกมเดียว คือ **Bot (Easy)**, **Bot (Normal)** และ **Bot (Hard)**
